...
- (void)receiveMessagePressed:(UIBarButtonItem *)sender
{
     ...
     */
    JSQMessage *copyMessage = [[self.chatModel.messages lastObject] copy];
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(3.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        NSMutableArray *userIds = [[self.chatModel.users allKeys] mutableCopy];
        ...
        if (copyMessage.isMediaMessage) {
            ...
            newMessage = [JSQMessage messageWithSenderId:randomUserId
                                             displayName:self.chatModel.users[randomUserId]
                                                   media:newMediaData];
        }
        else {
            /**
        ...
        [self.chatModel.messages addObject:newMessage];
...
- (void)actionSheet:(UIActionSheet *)actionSheet didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    ...
    switch (buttonIndex) {
        case 0:
            [self.chatModel addPhotoMediaMessage];
            break;
        ...
        case 1:
        {
            ...
            [self.chatModel addLocationMediaMessageCompletion:^{
                [weakView reloadData];
            }];
        }
            break;
        ...
        case 2:
            [self.chatModel addVideoMediaMessage];
            break;
            
        case 3:
            [self.chatModel addVideoMediaMessageWithThumbnail];
            break;
            
        case 4:
            [self.chatModel addAudioMediaMessage];
            break;
    }
...
- (id<JSQMessageBubbleImageDataSource>)collectionView:(JSQMessagesCollectionView *)collectionView messageBubbleImageDataForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    JSQMessage *message = [self.chatModel.messages objectAtIndex:indexPath.item];
    
    if ([message.senderId isEqualToString:self.senderId]) {
        return self.chatModel.outgoingBubbleImageData;
    }
    
    return self.chatModel.incomingBubbleImageData;
}
...
- (id<JSQMessageAvatarImageDataSource>)collectionView:(JSQMessagesCollectionView *)collectionView avatarImageDataForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return [self.chatModel.avatars objectForKey:message.senderId];
}
...
- (NSAttributedString *)collectionView:(JSQMessagesCollectionView *)collectionView attributedTextForMessageBubbleTopLabelAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.item - 1 > 0) {
        JSQMessage *previousMessage = [self.chatModel.messages objectAtIndex:indexPath.item - 1];
...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    JSQMessage *msg = [self.chatModel.messages objectAtIndex:indexPath.item];
                   ...
                   layout:(JSQMessagesCollectionViewFlowLayout *)collectionViewLayout heightForMessageBubbleTopLabelAtIndexPath:(NSIndexPath *)indexPath
{
     ...
     *  iOS7-style sender name labels
     */
    JSQMessage *currentMessage = [self.chatModel.messages objectAtIndex:indexPath.item];
